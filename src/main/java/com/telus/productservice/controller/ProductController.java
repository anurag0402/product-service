package com.telus.productservice.controller;

import com.telus.productservice.dto.ProductDTO;
import com.telus.productservice.service.ProductService;
...
public class ProductController {
    ...
    // DELETE
    @Operation(summary = "Delete product", description = "No content")
    @DeleteMapping("/{id}")
